...
class RolePermissionList extends ListResource
    {
    /**
     * Construct the RolePermissionList
     *
    ...
    public function __construct(
        ...
        $this->uri = '/Roles/' . \rawurlencode($roleSid)
        .'/Permissions';
    }

    /**
     * Reads RolePermissionInstance records from the API as a list.
     ...
     * @return RolePermissionInstance[] Array of results
     */
    ...
    /**
     * Streams RolePermissionInstance records from the API as a generator stream and returns result with Metadata
     * This operation lazily loads records as efficiently as possible until the
     * limit
     * is reached.
     * The results are returned as a generator, so this operation is memory
     ...
     * @param string $pageToken PageToken provided by the API
     * @param mixed $pageNumber Page Number, this value is simply for client state
     * @return RolePermissionPage Page of RolePermissionInstance
     */
    ...
    ): RolePermissionPage
    {
        ...
        return new RolePermissionPage($this->version, $response, $this->solution);
    }

    /**
     * Retrieve a single page of RolePermissionInstance records with metadata
     * Request is executed immediately
     *
     * @param mixed $pageSize Number of records to return, defaults to 50
     * @param string $pageToken PageToken provided by the API
     * @param mixed $pageNumber Page Number, this value is simply for client state
     * @return PageMetadata of RolePermissionInstance
     */
    ...
    ): PageMetadata
    {
        ...
        $resource =  new RolePermissionPage($this->version, $response, $this->solution);
     ...
     * @return RolePermissionPage Page of RolePermissionInstance
     */
    public function getPage(string $targetUrl): RolePermissionPage
    {
