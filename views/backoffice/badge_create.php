...
<div class="mb-4 d-flex align-items-center">
    ...
    <h2 class="mb-0">Create New Badge</h2>
</div>
...
<div class="card shadow-sm border-0">
    <div class="card-body p-4">
        ...
        <form action="index.php?action=store_badge" method="POST" novalidate>
            ...
            <div class="mb-4">
                ...
                <textarea class="form-control <?= isset($errors['description']) ? 'is-invalid' : '' ?>" 
                          ...
                          placeholder="Describe the badge..."><?= isset($description) ? htmlspecialchars($description) : '' ?></textarea>
            ...
            <button type="submit" class="btn btn-primary btn-lg">Save Badge</button>
        </form>
