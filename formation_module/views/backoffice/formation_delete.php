...
<div class="card border-danger shadow-sm">
    ...
    <div class="card-body p-4">
        ...
        <div class="p-3 bg-light rounded mb-4 border">
            <p class="mb-1"><strong class="text-muted">ID:</strong> <?= htmlspecialchars($formation->getId()) ?></p>
            <p class="mb-0"><strong class="text-muted">Title:</strong> <span class="fw-bold"><?= htmlspecialchars($formation->getTitle()) ?></span></p>
        </div>
        
        <form action="index.php?action=delete_formation&id=<?= htmlspecialchars($formation->getId()) ?>" method="POST">
