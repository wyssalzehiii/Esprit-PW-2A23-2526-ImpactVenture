...
<!-- SIDEBAR -->
<aside class="hidden lg:flex fixed inset-y-0 left-0 z-40 w-72 flex-col bg-gray-900 text-white border-r border-white/10">
    <div class="p-6 border-b border-white/10">
        ...
        <p class="text-xs text-gray-400 mt-2">Panneau de gestion</p>
    </div>
    ...
    <nav class="flex-1 overflow-y-auto p-4">
        ...
        <div class="mb-5">
            <p class="sidebar-section-title">Module 02</p>
            <a href="index.php?action=admin" class="sidebar-link">
                <i class="fas fa-tags w-5 text-center"></i>
                <span>Gestion Thèmes</span>
            </a>
            <a href="index.php?action=trending" class="sidebar-link">
        ...
        <div class="mb-5">
            <p class="sidebar-section-title">Autres modules</p>
            ...
            <a href="index.php?action=admin_financement" class="sidebar-link active">
                ...
                <?php foreach ($investisseurs as $inv): ?>
                    ...
                    <div class="inv-card glass-card rounded-3xl p-6 flex flex-col gap-5 investor-card"
                        ...
                        <div class="flex gap-3 pt-2">
                            ...
                            <a href="index.php?action=admin_investisseur_edit&id=<?= (int)$inv['id'] ?>"
                               class="flex-1 text-center px-4 py-3 rounded-2xl bg-blue-600 text-white font-semibold hover:bg-blue-700 transition">
